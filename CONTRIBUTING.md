# Contributing to dhi13man-portfolio-app

Thanks for improving dhi13man-portfolio-app. Open an issue first for large changes so we can
agree on scope.
...
3. Install the toolchain this repo already uses (Node.js) and any dependencies
