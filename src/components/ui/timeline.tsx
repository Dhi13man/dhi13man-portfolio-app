...
const TimelineMeta = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
...
const TimelineDate = React.forwardRef<HTMLTimeElement, React.TimeHTMLAttributes<HTMLTimeElement>>(
  ({ className, ...props }, ref) => (
    <time ref={ref} className={cn('text-12 font-mono text-text-quaternary', className)} {...props} />
  )
)
TimelineDate.displayName = 'TimelineDate'

const TimelineLocation = React.forwardRef<HTMLSpanElement, React.HTMLAttributes<HTMLSpanElement>>(
  ({ className, ...props }, ref) => (
    <span ref={ref} className={cn('text-12 text-text-tertiary', className)} {...props} />
  )
)
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn('text-14 text-text-secondary leading-relaxed', className)} {...props} />
))
